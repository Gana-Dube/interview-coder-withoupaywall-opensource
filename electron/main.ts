...
export interface IShortcutsHelperDeps {
  ...
  moveWindowUp: () => void
  moveWindowDown: () => void
  moveWindowLeftSmall: () => void
  moveWindowRightSmall: () => void
  moveWindowUpSmall: () => void
  moveWindowDownSmall: () => void
}
...
function initializeHelpers() {
  ...
  state.shortcutsHelper = new ShortcutsHelper({
    ...
    moveWindowLeftSmall: () =>
      moveWindowHorizontal((x) =>
        Math.max(-(state.windowSize?.width || 0) / 2, x - state.smallStep)
      ),
    moveWindowRightSmall: () =>
      moveWindowHorizontal((x) =>
        Math.min(
          state.screenWidth - (state.windowSize?.width || 0) / 2,
          x + state.smallStep
    ...
    moveWindowUpSmall: () => moveWindowVertical((y) => y - state.smallStep),
    moveWindowDownSmall: () => moveWindowVertical((y) => y + state.smallStep)
